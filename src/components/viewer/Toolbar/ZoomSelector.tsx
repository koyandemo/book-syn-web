    ...
    <div class="flex justify-center items-center space-x-1 mt-2">
      ...
      <DropdownMenu.Root modal={false}>
        <DropdownMenu.Trigger
          class="flex w-[120px] text-left items-center bg-slate-200/70 hover:bg-slate-200 py-1 rounded-sm focus:border-gray-400 focus:ring-0 outline-none border border-transparent"
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
          }}
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            class="absolute w-[100px] max-w-[142px] right-0 left-0 z-30 mt-1 origin-top-right divide-y divide-slate-200 rounded text-left bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none animate-content-hide ui-expanded:animate-content-show"
            role="menu"
