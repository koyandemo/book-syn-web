...
const ButtonsBar = ({
  ...
  return (
    <div
      class={`bg-slate-100/10 z-10 flex flex-col p-1 py-2 space-y-3 items-center border-r border-r-slate-300 shadow-sm transition-all [box-shadow:1px_0_2px_0_rgb(0_0_0_/_0.05)]`}
      classList={{
    ...
    >
      ...
      <div>
        <a href='https://pdfslick.dev/docs' target='_blank'>
          <img src='/logo/pdfslick.png' class='w-4 h-4'></img>
        </a>
      </div>
      {/* <button
